...
plt.suptitle('Agent Trajectory v6 (SAC+LSTM, 20 episodes)', fontsize=14)
plt.tight_layout()
plt.savefig('/work/my_research/trajectory_v6_20ep.png', dpi=100, bbox_inches='tight')
print("Saved: trajectory_v6_20ep.png")
