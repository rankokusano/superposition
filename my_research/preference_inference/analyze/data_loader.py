...
class DataLoader(object):
    ...
    def get_a2_landmark_label(self, mode):
        """Return A-2 target landmark integer labels (N, T)."""
        return self.data[mode]['a2_target_landmark']['input']

    def get_flatten_a2_landmark_label(self, mode='eval'):
        labels = self.get_a2_landmark_label(mode)
