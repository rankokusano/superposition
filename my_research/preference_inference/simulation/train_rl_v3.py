"""
v3 RL agent training: A-1 learns red-preference + green-aversion via SAC.
...
Run inside Docker:
    xvfb-run --auto-servernum --server-args='-screen 0 1024x768x24' \
        python -u my_research/preference_inference/simulation/train_rl_v3.py \
...
def vision_to_tensor(vision_np):
    """Float32 [0,1] HWC → 1×3×H×W tensor."""
