...
def train():
    ...
    print(f"学習開始 ({DEVICE})")
    print(f"報酬設計：赤いピクセルの数（赤ランドマークは左上(-9,9)）")
    ...
    torch.save(model.state_dict(), '/work/my_research/rl_model_v2.pth')
    print("学習完了: rl_model_v2.pth を保存しました")
