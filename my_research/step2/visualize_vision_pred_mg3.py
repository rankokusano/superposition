...
使い方:
    ...
    MESA_GL_VERSION_OVERRIDE=3.3 xvfb-run python3 visualize_vision_pred_mg3.py \\
        --run mg3_YYYYMMDD_HHMMSS

    # パス直接指定も可
    MESA_GL_VERSION_OVERRIDE=3.3 xvfb-run python3 visualize_vision_pred_mg3.py \\
        --run /work/my_research/step2/results/mg3_YYYYMMDD_HHMMSS

出力:
    {run_dir}/vision_pred_mg3.png   ← 比較図
    標準出力にピクセル誤差 (MAE) を表示
"""
...
MODEL_FILE = os.path.join(RUN_DIR, 'model_mg3.pth')
SAVE_PATH  = os.path.join(RUN_DIR, 'vision_pred_mg3.png')
