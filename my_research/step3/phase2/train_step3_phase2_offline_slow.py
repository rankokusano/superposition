"""
train_step3_phase2_offline_slow.py

Phase 2 offline バッチ訓練（A-2 slow 版）。
...
実行コマンド（コンテナ内）:
    ...
    python3 my_research/step3/phase2/train_step3_phase2_offline_slow.py \\
...
DATA_PATH   = os.path.join(PROJ_ROOT, 'data/data/self_random_other_stay_slow_pref/data.h5')
...
RUN_DIR         = os.path.join(STEP3_DIR, 'results', f'phase2_slow_pref_{_TIMESTAMP}')
